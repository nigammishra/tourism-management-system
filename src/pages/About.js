  ...
  <ol className="ccardds__container" title="Blog entries">
    ...
    <li className="ccardd">
      ...
      <Slide direction='down'>
        ...
        </Slide><a className="ccardd__btn" aria-label="Read more about ccardd Title 3" href="#"><img src={smll} alt /></a>
      </div>
    </li>
    <li className="ccardd">
      <div className="ccardd__thumb">
    ...
    <li className="ccardd">
      ...
      <Slide direction='down'>
        ...
        </Slide><a className="ccardd__btn" aria-label="Read more about ccardd Title 4" href="#"><img src={smll} alt /></a>
      </div>
    </li>
    <li className="ccardd">
      <div className="ccardd__thumb">
